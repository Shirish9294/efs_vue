    ...
    <v-container fluid>
      ...
      <v-row align="center" justify="center">
        <v-col cols="12" md="10" v-resize="onResize">
          ...
          >
            <template v-slot:item="props">
              <tr>
                ...
                <td align="center">
                  <v-icon @click="updateCustomer(props.item)"
                    >mdi-pencil</v-icon
                  >
                </td>
                <td align="center">
                  <v-icon @click="deleteCustomer(props.item)"
                    >mdi-delete</v-icon
                  >
                </td>
              </tr>
          ...
          <v-data-iterator :items="customers" hide-default-footer v-else>
                  ...
                  <v-card>
                    <v-card-title class="pb-0 pt-0 pl-0">
                      ...
                      <v-col cols="3" class="text-center">
                        <v-card-actions>
                          <v-icon @click="updateCustomer(item)" class="small"
                            >mdi-pencil</v-icon
                          >
                          <v-icon @click="deleteCustomer(item)" class="small"
                            >mdi-delete</v-icon
                          >
                          <v-icon
          ...
          <v-btn class="blue mt-4 white--text" @click="addNewCustomer"
            >Add Customer</v-btn
          >
        </v-col>
      </v-row>
